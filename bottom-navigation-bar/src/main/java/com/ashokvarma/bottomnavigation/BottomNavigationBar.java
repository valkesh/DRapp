...
public class BottomNavigationBar extends FrameLayout {
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mInActiveColor = typedArray.getColor(R.styleable.BottomNavigationBar_bnbInactiveColor, Color.WHITE);
            mBackgroundColor = typedArray.getColor(R.styleable.BottomNavigationBar_bnbBackgroundColor, Color.parseColor("#EDEDED"));
...
//    }
     ...
     */
    public BottomNavigationBar setScrollable(boolean scrollable) {
