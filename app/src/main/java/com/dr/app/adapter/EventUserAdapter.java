...
public class EventUserAdapter extends PagingBaseAdapter<String> {
    private LayoutInflater mInflater;
    Context mContext;
    Holder holder;
    Activity mContext_act;
    public ArrayList<EventUserModel> mList = new ArrayList<EventUserModel>();
    ...
    public interface OnDetailsItem {
        void onProfile(ArrayList<EventUserModel> mList, int pos);
    }

    public EventUserAdapter(Activity context, EventUserAdapter.OnDetailsItem mdListener,
                            ArrayList<EventUserModel> mList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_event_user, parent,
                    false);
            holder = new EventUserAdapter.Holder();
            ...
            holder = (EventUserAdapter.Holder) convertView.getTag();
        }
