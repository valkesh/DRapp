...
public class MainActivityDR extends BackStackActivity implements OnTabSelectedListener {
    private static final String STATE_CURRENT_TAB_ID = "current_tab_id";
    private static final int MAIN_TAB_ID = 0;
    public static MainActivityDR mMainActivity;
...
//    }
    ...
    private void setUpBottomNavBar() {
        ...
        bottomNavBar
                ...
                .addItem(new BottomNavigationItem(R.drawable.add_on, R.string.post).setInactiveIconResource(R.drawable.add))
    ...
    private Fragment rootTabFragment(int tabId) {
        switch (tabId) {
            case 0:
                return HomeDemoFragmentDR.newInstance(getString(R.string.home));
            case 1:
//                if (Pref.getIsLogin()) {
...
//                }
                return CreateEventFragmentDR.newInstance(getString(R.string.post));

            case 2:
                return AboutFragmentDR.newInstance(getString(R.string.isnotuserprofile));
            case 3:
...
//                }
    ...
    public boolean openAddressMap() {
        boolean is_permision_grant = false;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION}, 0);

                is_permision_grant = false;
            } else {
                is_permision_grant = true;
            }
        } else {
            is_permision_grant = true;
        }
        return is_permision_grant;
    }
